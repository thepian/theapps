...
class TagField(CharField):
    ...
    def __get__(self, instance, owner=None):
        ...
        if instance is None:
            return edit_string_for_tags(self.Tag.objects.usage_for_model(owner))
        ...
        if tags is None:
            if instance.pk is None:
                ...
                self._set_instance_tag_cache(
                    instance, edit_string_for_tags(self.Tag.objects.get_for_object(instance)))
    ...
    def _save(self, **kwargs): #signal, sender, instance):
        ...
        if tags is not None:
            self.Tag.objects.update_tags(kwargs['instance'], tags)
